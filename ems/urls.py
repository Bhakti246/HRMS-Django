...
app_name="ems"
urlpatterns=[
 path("",views.entrypoint,name="entrypoint"),path("setup/",views.setup,name="setup"),path("login/",views.login_view,name="login"),path("password/change/",views.password_change,name="password_change"),path("dashboard/",views.dashboard,name="dashboard"),path("logout/",views.logout_view,name="logout"),path("profile/",views.profile,name="profile"),path("profile/attendance/",views.attendance_action,name="attendance_action"),path("profile/attendance/state/",views.attendance_state,name="attendance_state"),
